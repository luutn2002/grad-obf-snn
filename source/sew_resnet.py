...
class SEWResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, cnf: str = None, spiking_neuron: callable = None, 
                 pooling_layer: callable = None, **kwargs):
        super().__init__()
        if norm_layer is None:
            norm_layer = layer.BatchNorm2d
        ...
        self.sn1 = spiking_neuron(**deepcopy(kwargs))
        self.pool = pooling_layer(kernel_size=3, stride=2, padding=1)
...
def _sew_resnet(arch, block, layers, pretrained, progress, cnf, spiking_neuron, pooling_layer, **kwargs):
    model = SEWResNet(block, layers, cnf=cnf, spiking_neuron=spiking_neuron, pooling_layer=pooling_layer, **kwargs)
    if pretrained:
...
def sew_resnet18(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    ...
    return _sew_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)


def sew_resnet34(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    return _sew_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)

def sew_resnet50(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    return _sew_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)

def sew_resnet101(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    return _sew_resnet('resnet101', Bottleneck, [3, 4, 23, 3], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)

def sew_resnet152(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    return _sew_resnet('resnet152', Bottleneck, [3, 8, 36, 3], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)

def sew_resnext50_32x4d(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    return _sew_resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)


def sew_resnext101_32x8d(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    return _sew_resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)


def sew_wide_resnet50_2(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    return _sew_resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)

def sew_wide_resnet101_2(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, pooling_layer: callable=layer.MaxPool2d, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _sew_resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3], pretrained, progress, cnf, spiking_neuron, pooling_layer=pooling_layer, **kwargs)